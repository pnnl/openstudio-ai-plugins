...
DEFAULT_PACKAGE_SPEC = "openstudio-ai==0.4.0"
...
def main() -> int:
    ...
    print("\nAfter the update, run /reload-plugins or reconnect the MCP server so Claude Code starts openstudio-ai-mcp again and discovers any newly added tools.")
    return 0
